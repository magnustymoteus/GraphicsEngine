	...
	*/
	...
	class LSystem
	{
		...
		public:
            ...
            /**
            * \brief Stochastic replacement function. Returns the replacement string for a given character of the Alphabet randomly
            *
            * \param c 	the character of the alphabet
            *
            * \return	replacement string
            */
            std::string get_stochastic_replacement(char c) const;
		...
		protected:
			...
			double angle;
		         ...
		         */
			std::map<char, std::map<std::string, double>> replacementrules;
