...
namespace img
{
	...
	class EasyImage
	{
		public:
			 ...
			 */
			EasyImage(int width, int height, Color color = Color());
            ...
            void draw_zbuf_line(int x0, int y0, double z0, int x1, int y1,
                                double z1, Color color, ZBuffer &zbuffer);
            void color_zbuf_pixel(int a, int i, int x, int y, double z0, double z1,
